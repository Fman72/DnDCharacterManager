# Generated by Django 3.1.3 on 2020-11-30 17:59
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('casterId', models.IntegerField()),
                ('casterType', models.CharField(choices=[('Character', 'Character'), ('NPC', 'Npc'), ('Object', 'Object')], max_length=100)),
                ('targetId', models.IntegerField(null=True)),
                ('targetType', models.CharField(choices=[('Character', 'Character'), ('NPC', 'Npc'), ('Object', 'Object')], max_length=100, null=True)),
                ('ability', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.ability')),
                ('gameSession', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.gamesession')),
            ],
        ),
        migrations.CreateModel(
            name='AbilityClass',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('ability', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.ability')),
                ('characterClass', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.characterclass')),
            ],
        ),
        migrations.AddField(
            model_name='ability',
            name='characterClasses',
            field=models.ManyToManyField(through='api.AbilityClass', to='api.CharacterClass'),
        ),
    ]
